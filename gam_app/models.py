...
class Carpeta(models.Model):
    ...
    person_status = models.CharField(max_length= 20, choices=PERSON_STATUS_CHOICES, null=True, blank=True)
    place_status = models.CharField(max_length= 20, choices=PLACE_STATUS_CHOICES, null=True, blank=True)
    organization_status = models.CharField(max_length= 20, choices=ORGANIZATION_STATUS_CHOICES, null=True, blank=True)

    def __str__(self):
        if '{}/{}/{}'.format(self.caja, self.legajo, self.carpeta) is None:
            return "ERROR"
        else:
