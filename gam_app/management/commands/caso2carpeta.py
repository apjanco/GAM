...
class Command(BaseCommand):
        ...
        def handle(self, *args, **options):
                ...
                carpetas = Imagen.objects.values('archivo','colección', 'caja', 'legajo', 'carpeta').distinct()
                for carpeta in carpetas:
                	...
                	folders = Caso.objects.filter(caja_no=caja, legajo_no=legajo, carpeta_no=carpeta)
                	print(folders)
                    for file in folders:
