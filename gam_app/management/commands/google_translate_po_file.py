...
class Command(BaseCommand):
    help = "Uses Google Translate to automatically populate the Django po file with translations. Takes arguments for source language, target language and file path. Note: English = en, Spanish = es, German = de."
